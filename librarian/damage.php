...
<?php include('dbcon.php'); ?> <!-- Make sure this creates $connect = new mysqli(...) -->
<div class="container">
        ...
        <div class="row">
            <div class="span12">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered" id="example">
                    ...
                    <tbody>
                        <?php
                        $stmt = $connect->prepare("SELECT * FROM book WHERE status = 'Damage'");
                        $stmt->execute();
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            // Get category
                            $cat_stmt = $connect->prepare("SELECT classname FROM category WHERE category_id = ?");
