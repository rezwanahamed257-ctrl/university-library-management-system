        ...
        <div class="row">    
            <div class="span12">    
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered" id="example">
                    ...
                    <tbody>
                        <?php  
                        $book_query = mysqli_query($connection, "SELECT * FROM book WHERE status = 'Subject for Replacement'") 
                        ...
                        while($row = mysqli_fetch_assoc($book_query)){
                            ...
                            $cat_query = mysqli_query($connection, "SELECT classname FROM category WHERE category_id = '$cat_id'")
                                or die(mysqli_error($connection));
